...
public class AppointmentAddController implements Initializable {
    ...
    /**
     * Checks form for any errors and saves appointment to database
     * @param e
     * @throws IOException
     * @throws SQLException
     */
    public void onSavePressed(ActionEvent e) throws IOException, SQLException {
        try {
            ...
            ZonedDateTime zonedDateTimeBegin = ZonedDateTime.of(localDateTimeBegin, UserLoginController.user.getZoneId()/*ZoneId.systemDefault()*/);
            ZonedDateTime zonedDateTimeEnd = ZonedDateTime.of(localDateTimeEnd, UserLoginController.user.getZoneId()/*ZoneId.systemDefault()*/);
            ...
            //DEBUGGING
            System.out.println("User entered start time: " + startTimeStamp);
            System.out.print("User entered end time "  + endTimeStamp);
            ...
            if (noErrors()) {
                appt.addAppointment(title, description, location, type, startTimeStamp, endTimeStamp, updateTime, updateTime, user, customerID, userId, contactID);
    ...
    /**
     * Checks the form for any errors and displays accordingly
     * @return
     */
    ...
    /**
     * Checks if the appointment overlaps with any other appointment in the database
     * @param startTime
     * @param endTime
     * @param date
     * @return
    ...
    public Boolean checkCustomerOverlap(LocalDateTime startTime, LocalDateTime endTime, LocalDate date)
    {
        ...
        for(Appointment checkAppointment : appointmentList)
        {
            ...
            // Check if end time falls anywhere in the new appt
    ...
    /**
     * Checks if the scheduled appointment is outside of business hours New York
     * @param startTime
     * @param endTime
     * @param date
     * @return
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        userField.setText(String.valueOf(UserLoginController.user.getUserId()));
